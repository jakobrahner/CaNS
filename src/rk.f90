...
module mod_rk
  use mod_mom  , only: momx_a,momy_a,momz_a, &
                       ...
                       mom_xyz_ad
#if defined(_LES)
  use mod_mom  , only: mom_xyz_ad_les
#endif
...
!#endif
  ...
  !
#if defined(_LES)
  subroutine rk_les(rkpar,n,dli,dzci,dzfi,grid_vol_ratio_c,grid_vol_ratio_f,visc,dt,p, &
    ...
    !
    call mom_xyz_ad_les(n(1),n(2),n(3),dli(1),dli(2),dzci,dzfi,visc,u,v,w,visct, &
